...
SECRET_KEY = 'django-insecure-idw%58sa47umm)o9bc1rkaowkrh#=9ji*ipt_g+&pbud-yfdd-'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), '/home/dansamoru/Projects/fintech/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
